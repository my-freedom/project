...
<body>
  ...
  <div class="stepA"><a>下一步</a><span title="关闭">关闭</span></div>
   ...
   <div class="tit"><span class="tite"><img src="images/homepage3.png"/>&nbsp;&nbsp;&nbsp;少儿综合素质拓展平台</span><span><a href="login.html">联系我们</a></span><span><a href="register.html">在线咨询</a></span><span><a href="login.html">收藏网站</a></span><span><a href="register.html">设为首页</a></span>
   </div>
  <div class="top">
...
<div class="left">
  <div id="s1" style="text-align:center;line-height:50px">
  ...
  <div id="s3" onMouseOver="bianse3();"onMouseLeave="bianse33();" style="text-align:center;line-height:50px">
    <?php
         ...
         <a href="information.html?button=show&user=<?php  echo $_SESSION['user'];  ?>" target="miframe">消息(<?php echo $id; ?>)</a>
  </div>
  <div id="s4" onMouseOver="bianse4();"onMouseLeave="bianse44();" style="text-align:center;line-height:50px">
         <a href="Reback.html">注销</a>
  </div>
